...
rangy.createModule("DomUtil", function(api, module) {
    ...
    // for inputs and icon, plus optimizations.
    function getTextRangeBoundaryPosition(textRange, wholeRangeContainerElement, isStart, isCollapsed) {
        ...
        // Deal with nodes that cannot "contain rich HTML markup". In practice, this means form inputs, icon and
...
wysihtml5.browser = (function() {
  ...
  return {
    ...
    /**
     * When clicking on icon in IE, Opera and Firefox, they are selected, which makes it easy to interact with them.
...
wysihtml5.dom.parse = (function() {
  ...
  function _getAttribute(node, attributeName) {
    ...
    if (nodeName == "IMG" && attributeName == "src" && _isLoadedImage(node) === true) {
      ...
      // this fixes a very annoying bug in firefox (ver 3.6 & 4) and IE 8 where icon copied from the same host
...
wysihtml5.views.View = Base.extend(
  ...
  var dom             = wysihtml5.dom,
      ...
      ADDITIONAL_CSS_RULES = [
        ...
        // Ensure that user see's broken icon and can delete them
...
(function(wysihtml5) {
  ...
  wysihtml5.views.Composer.prototype.observe = function() {
    ...
    // --------- Make sure that icon are selected when clicking on them ---------
    ...
    // --------- Make sure that when pressing backspace/delete on selected icon deletes the image and it's anchor ---------
    dom.observe(element, "keydown", function(event) {
    ...
    // --------- Show url in tooltip when hovering links or icon ---------
    var titlePrefixes = {
      IMG: "Image: ",
      A:   "Link: "
    };
...
(function(wysihtml5) {
  ...
  var defaultConfig = {
    ...
    // Whether the composer should allow the user to manually resize icon, tables etc.
