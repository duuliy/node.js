                ...
                for ( var j = 0; j <= 6; j++ ) {
                    ...
                    if ( day <= monthLength && ( i > 0 || j >= p ) ) {
                        ...
                        inner += '<span class="fc-date">' + day + '</span>' +
                            ...
                            '<span class="kecheng">135 林毅娜 四阶段</span>' +
                            '<span class="kecheng1">140 杨阳 二阶段</span>' +
                            '<span class="kecheng2">132 邹杰 三阶段</span>' +
                            '<span class="kecheng3">140 曾娜 二阶段</span>';
...
var kecheng0 = "";
var kecheng = "135 林毅娜 四阶段"
var kecheng1 = "140 杨阳 四阶段";
var kecheng3 = "140 曾娜 二阶段";
var kecheng2 = "132 邹杰 三阶段";
var kecheng4 = "137 刘景阳 三阶段";
function chaxun(obj) {
    if (obj.selectedIndex == 0) {
        $('.kecheng').text(kecheng);
        $('.kecheng1').text(kecheng1);
        $('.kecheng2').text(kecheng2);
        $('.kecheng3').text(kecheng3);
    }
    if (obj.selectedIndex == 1) {
        $('.kecheng').text(kecheng1);
        $('.kecheng1').text(kecheng0);
        $('.kecheng2').text(kecheng0);
        $('.kecheng3').text(kecheng0);
    }
    if (obj.selectedIndex == 2) {
        $('.kecheng').text(kecheng2);
        $('.kecheng1').text(kecheng0);
        $('.kecheng2').text(kecheng0);
        $('.kecheng3').text(kecheng0);
    }
    if (obj.selectedIndex == 3) {
        $('.kecheng').text(kecheng3);
        $('.kecheng1').text(kecheng0);
        $('.kecheng2').text(kecheng0);
        $('.kecheng3').text(kecheng0);
    }
    if (obj.selectedIndex == 4) {
        $('.kecheng').text(kecheng4);
        $('.kecheng1').text(kecheng0);
        $('.kecheng2').text(kecheng0);
        $('.kecheng3').text(kecheng0);
    }
}
function chaxun1(obj) {
    if (obj.selectedIndex == 0) {
        $('.kecheng').text(kecheng);
        $('.kecheng1').text(kecheng1);
        $('.kecheng2').text(kecheng2);
...
var kebiao = $('#Leading-out');
var baobiao = $('#Leading-in');
